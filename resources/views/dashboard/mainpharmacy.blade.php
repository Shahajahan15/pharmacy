                ...
                <div class="col-lg-4 col-xs-6 no-padding-right">
                    <div class="white-box">
                        <div class="r-icon-stats"><i class="fa fa-plus bg-megna"></i>
                            <div class="bodystate">
                                <h4>
                                    <small class="badge bg-green">TK: {{$mcashIn}}</small>
                                </h4>
                ...
                <div class="col-lg-4 col-xs-6 no-padding-right">
                    <div class="white-box">
                        <div class="r-icon-stats"><i class="fa fa-minus bg-megna"></i>
                            <div class="bodystate">
                                <h4>
                                    <small class="badge bg-aqua">TK:{{$mcashRn}}</small>
                                </h4>
                ...
                <div class="col-lg-4 col-xs-6 no-padding-right">
                    <div class="white-box">
                        <div class="r-icon-stats"><i class="fa fa-star-half-o bg-megna"></i>
                            <div class="bodystate">
                                <h4>
                                    <small class="badge bg-aqua">TK:{{$mcashIn - $mcashRn}}</small>
                                </h4>
                ...
                <div class="col-lg-4 col-xs-6 no-padding-right">
                    <div class="white-box">
                        <div class="r-icon-stats"><i class="fa fa-plus bg-megna"></i>
                            <div class="bodystate">
                                <h4>
                                    <small class="badge bg-green">TK: {{$scashIn}}</small>
                                </h4>
                                <span class="tile-label-dash">Today Cash Receive </span>
                            </div>
                        </div>
                ...
                <div class="col-lg-4 col-xs-6 no-padding-right">
                    <div class="white-box">
                        <div class="r-icon-stats"><i class="fa fa-minus bg-megna"></i>
                            <div class="bodystate">
                                <h4>
                                    <small class="badge bg-aqua">TK:{{$scashRn}}</small>
                                </h4>
                                <span class="tile-label-dash">Today Cash Return</span>
                            </div>
                        </div>
                ...
                <div class="col-lg-4 col-xs-6 no-padding-right">
                    <div class="white-box">
                        <div class="r-icon-stats"><i class="fa fa-star-half-o bg-megna"></i>
                            <div class="bodystate">
                                <h4>
                                    <small class="badge bg-aqua">TK:{{$scashIn - $scashRn}}</small>
                                </h4>
                                <span class="tile-label-dash">Nit Cash Receive</span>
                            </div>
                        </div>
                            ...
                            <div class="bodystate">
                                <h4>
                                    <small class="badge bg-aqua">
                                        TK:{{$mcashIn - $mcashRn + $scashIn - $scashRn}}</small>
                                </h4>
