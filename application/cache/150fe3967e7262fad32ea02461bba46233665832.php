                ...
                <div class="col-lg-4 col-xs-6 no-padding-right">
                    <div class="white-box">
                        <div class="r-icon-stats"> <i class="fa fa-plus bg-megna"></i>
                            <div class="bodystate">
                                <h4><small class="badge bg-green">TK: <?php echo e($mcashIn); ?></small></h4> <span class="tile-label-dash">Today Cash Receive </span>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-4 col-xs-6 no-padding-right">
                    <div class="white-box">
                        <div class="r-icon-stats"> <i class="fa fa-minus bg-megna"></i>
                            <div class="bodystate">
                                <h4><small class="badge bg-aqua">TK:<?php echo e($mcashRn); ?></small></h4> <span class="tile-label-dash">Today Cash Return</span>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-4 col-xs-6 no-padding-right">
                    <div class="white-box">
                        <div class="r-icon-stats"> <i class="fa fa-star-half-o bg-megna"></i>
                            <div class="bodystate">
                                <h4><small class="badge bg-aqua">TK:<?php echo e($mcashIn - $mcashRn); ?></small></h4> <span class="tile-label-dash">Nit Cash Receive</span>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="row">
                ...
                <div class="col-lg-4 col-xs-6 no-padding-right">
                    <div class="white-box">
                        <div class="r-icon-stats"> <i class="fa fa-plus bg-megna"></i>
                            <div class="bodystate">
                                <h4><small class="badge bg-green">TK: <?php echo e($scashIn); ?></small></h4> <span class="tile-label-dash">Today Cash Receive </span>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-4 col-xs-6 no-padding-right">
                    <div class="white-box">
                        <div class="r-icon-stats"> <i class="fa fa-minus bg-megna"></i>
                            <div class="bodystate">
                                <h4><small class="badge bg-aqua">TK:<?php echo e($scashRn); ?></small></h4> <span class="tile-label-dash">Today Cash Return</span>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-4 col-xs-6 no-padding-right">
                    <div class="white-box">
                        <div class="r-icon-stats"> <i class="fa fa-star-half-o bg-megna"></i>
                            <div class="bodystate">
                                <h4><small class="badge bg-aqua">TK:<?php echo e($scashIn - $scashRn); ?></small></h4> <span class="tile-label-dash">Nit Cash Receive</span>
                            </div>
                        </div>
                    </div>
                </div>
              ...
              <div class="col-lg-12 col-xs-6 no-padding-right">
                    <div class="white-box">
                        <div class="r-icon-stats" style="text-align: center;"> <i class="fa fa-money bg-megna"></i>
                            <div class="bodystate">
                                <h4><small class="badge bg-aqua">TK:<?php echo e($mcashIn - $mcashRn + $scashIn - $scashRn); ?></small></h4> <span class="tile-label-dash">Total Cash Collection</span>
                            </div>
                        </div>
                    </div>
                </div>
...
<script>
    var cashMainDailyChartData = <?php echo $cashMainDailyChartData; ?>;     
    var cashSubDailyChartData = <?php echo $cashSubDailyChartData; ?>;
    var cashMainMonthlyChartData = <?php echo $cashMainMonthlyChartData; ?>;
    var cashSubMonthlyChartData = <?php echo $cashSubMonthlyChartData; ?>;
