...
<html lang="en">
<head>
    <?php echo $__env->make('layout/_adminheader', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
...
<header class="header hidden-print">
    ...
    <a href="<?php echo e(site_url()); ?>/admin/admin_content" class="logo-link">
    ...
    <div class="wrapper row-offcanvas row-offcanvas-left hidden-print">
        ...
        <?php echo $__env->make('layout/_adminleft_nav', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>

        <!-- Right side column. Contains the navbar and content of the page -->
        <aside class="right-side">
            <?php echo $__env->make('layout/_admincontent_header', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
