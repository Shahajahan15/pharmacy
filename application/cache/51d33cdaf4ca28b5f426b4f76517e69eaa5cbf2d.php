...
<?php $__env->startSection('content'); ?>
                ...
                <div class="col-lg-4 col-xs-6 no-padding-right">
                    <div class="white-box">
                        <div class="r-icon-stats"><i class="fa fa-plus bg-megna"></i>
                            <div class="bodystate">
                                <h4>
                                    <small class="badge bg-green">TK: <?php echo e($mcashIn); ?></small>
                                </h4>
                                <span class="tile-label-dash">Today Cash Receive </span>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-4 col-xs-6 no-padding-right">
                    <div class="white-box">
                        <div class="r-icon-stats"><i class="fa fa-minus bg-megna"></i>
                            <div class="bodystate">
                                <h4>
                                    <small class="badge bg-aqua">TK:<?php echo e($mcashRn); ?></small>
                                </h4>
                                <span class="tile-label-dash">Today Cash Return</span>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-4 col-xs-6 no-padding-right">
                    <div class="white-box">
                        <div class="r-icon-stats"><i class="fa fa-star-half-o bg-megna"></i>
                            <div class="bodystate">
                                <h4>
                                    <small class="badge bg-aqua">TK:<?php echo e($mcashIn - $mcashRn); ?></small>
                                </h4>
                                <span class="tile-label-dash">Nit Cash Receive</span>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-4 col-xs-6 no-padding-right">
                    <div class="white-box">
                        <div class="r-icon-stats"><i class="fa fa-plus bg-megna"></i>
                            <div class="bodystate">
                                <h4>
                                    <small class="badge bg-green">TK: <?php echo e($scashIn); ?></small>
                                </h4>
                                <span class="tile-label-dash">Today Cash Receive </span>
                            </div>
                        </div>
                ...
                <div class="col-lg-4 col-xs-6 no-padding-right">
                    <div class="white-box">
                        <div class="r-icon-stats"><i class="fa fa-minus bg-megna"></i>
                            <div class="bodystate">
                                <h4>
                                    <small class="badge bg-aqua">TK:<?php echo e($scashRn); ?></small>
                                </h4>
                                <span class="tile-label-dash">Today Cash Return</span>
                            </div>
                        </div>
                ...
                <div class="col-lg-4 col-xs-6 no-padding-right">
                    <div class="white-box">
                        <div class="r-icon-stats"><i class="fa fa-star-half-o bg-megna"></i>
                            <div class="bodystate">
                                <h4>
                                    <small class="badge bg-aqua">TK:<?php echo e($scashIn - $scashRn); ?></small>
                                </h4>
                                <span class="tile-label-dash">Nit Cash Receive</span>
                            </div>
                        </div>
                ...
                <div class="col-lg-12 col-xs-6 no-padding-right">
                    <div class="white-box">
                        <div class="r-icon-stats" style="text-align: center;"><i class="fa fa-money bg-megna"></i>
                            <div class="bodystate">
                                <h4>
                                    <small class="badge bg-aqua">
                                        TK:<?php echo e($mcashIn - $mcashRn + $scashIn - $scashRn); ?></small>
                                </h4>
                                <span class="tile-label-dash">Total Cash Collection</span>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <div class="row panel">
        ...
        <div class="col-lg-6">
            <div class="nav-tabs-custom">
                <ul class="nav nav-tabs pull-right">
                    <li class="pull-left header"><i class="fa fa-bar-chart-o"></i>Monthly Cash collection(Main Pharmacy)
                    </li>
                </ul>
        ...
        <div class="col-lg-6">
            <div class="nav-tabs-custom">
                <ul class="nav nav-tabs pull-right">
                    <li class="pull-left header"><i class="fa fa-bar-chart-o"></i>Monthly Cash collection(Sub Pharmacy)
                    </li>
                </ul>
