    ...
    <table class="table table-bordered report-table">
     ...
     $total_payable = 0;
        ...
        <tr>
            ...
            <td><a class="btn btn-info btn-xs" href="<?php echo site_url(SITE_AREA . '/store_purchase_report/report/per_pay_details_details/'.$record->id); ?>" style="text-decoration:none;">view</a></td>
