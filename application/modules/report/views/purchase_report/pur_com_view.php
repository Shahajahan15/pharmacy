    ...
    <table class="table table-bordered report-table">
     ...
     <?php $sl=1;foreach($records as $record){?>
        <tr>
            ...
            <td><a class="btn btn-info btn-xs" href="<?php echo site_url(SITE_AREA . '/pharmacy_purchase_report/report/per_pay_details/'.$record->supplier_id); ?>" style="text-decoration:none;">view</a></td>
