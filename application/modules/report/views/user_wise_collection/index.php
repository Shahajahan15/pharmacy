...
<div class="text-center">
    <h3 style="background-color: #005B96; color: white;">User Wise Cash Collection</h3>
        ...
        <?php else: ?>
          <span>Date <?php echo date('d/m/Y') ; ?></span> <span class="date1"><?php echo date("h:i:sa"); ?></span></br>
