     ...
     <?php if ($discount_info) : ?>
      <tbody>
            ...
            <tr style="background: <?php echo $bc; ?>">
                ...
                <td><?php if($row->discount_type==1 && $row->source != 10){echo "Amount";}
                elseif($row->discount_type == 1 && $row->source == 10){echo "Refund";}
                elseif($row->discount_type==2 && $row->source != 10)
                    {
                        if ($row->type == 1) {
                ...
                elseif($row->type == 3 && $row->source != 10)
                    {
                        echo $total_discount = $row->sd_dicount;
                    }    
                elseif($row->type == 2 && $row->source != 10){
                 ...
                 ?></td>
                  <td><a class="btn btn-info btn-xs" href="<?php echo site_url(SITE_AREA . '/discount/report/details/'.$row->id); ?>" style="text-decoration:none;">view</a></td>
