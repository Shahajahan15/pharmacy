<div class="breadcrumb" >
    <?php //if ($this->auth->has_permission('Report.Refund.Print')) : ?>
        <a class="btn btn-info" href="<?php echo '#'; //site_url(SITE_AREA .'/patient_booth_serial/report/pdf') ?>" id="export-print">
            <i class="fa fa-print"></i> <?php echo "&nbsp&nbsp"."Print"."&nbsp&nbsp"; ?>
        </a>
    <?php //endif; ?>
    <?php if ($this->auth->has_permission('Report.Refund.Pdf')) : ?>
    ...
    <?php if ($this->auth->has_permission('Report.Refund.Excel')) : ?>
