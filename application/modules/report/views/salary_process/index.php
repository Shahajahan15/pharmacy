...
<fieldset>
			...
			<div class="form-group">
				...
				<div class="input-group">
					...
					<div class="input-group-addon btn-xs btn process-now">
						<span class=""><i class="fa fa-bolt" aria-hidden="true"> Process Now</i></span>
					</div>

					<div class="input-group-addon btn-xs btn btn-success sheet_print" href="<?php echo site_url();?>/admin/salary_process/hrm/print_salary_sheet">

						<span class=""><i class="fa fa-print" aria-hidden="true"> Print</i></span>
					</div>
				</div>
			</div>
		</div>
 ...
 <?php echo form_close(); ?>
<section id="employee-salary-table">
