...
class Company extends Admin_Controller 
{
    ...
    public function __construct() 
	{
        ...
        $this->load->model('setup_model', NULL, true);
    ...
    $data['form_action_url']=site_url('admin/setup/pharmacy/create');
    $data['list_action_url']=site_url('admin/setup/pharmacy/show_list');
    Template::set($data);
    ...
    public function show_list() 
	{
        ...
        $search_box['sub_customer_name_flag']=0;
    ...
    private function save_details($type = 'insert', $id = 0) 
	{
        ...
        $data['company_ceo_name'] = $this->input->post('pharmacy_company_ceo_name');
