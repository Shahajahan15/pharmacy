...
<?php
$num_columns = 8;
$can_delete = $this->auth->has_permission('Pharmacy.Category.Delete');
$can_edit = $this->auth->has_permission('Pharmacy.Category.Edit');
...
<?php if ($can_delete && $has_records) : ?>
                    ...
                    <th width="38%"><?php echo lang('pharmacy_category_status'); ?></th>
                </tr>
            </thead>
<?php if ($has_records) : ?>
                <tfoot>
                    ...
                    ?>
                        ...
                        <?php if ($can_delete) : ?>
                            ...
                            <td><?php echo $sl+=1; ?></td>
                                ...
                                <?php if ($can_edit) : ?>
                                <td><?php echo anchor(SITE_AREA . '/category/pharmacy/edit/' . $record->id, '<span class="glyphicon glyphicon-pencil"></span>' . $record->category_name,'class="bf-edit-action"'); ?></td>
                            <?php else : ?>
