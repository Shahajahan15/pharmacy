...
<?php
$num_columns	= 8;
$can_delete		= $this->auth->has_permission('Pharmacy.Generic.Delete');
$can_edit		= $this->auth->has_permission('Pharmacy.Generic.Edit');
	...
	<?php echo form_open($this->uri->uri_string()); ?>
		<table class="table table-striped">
			...
			<tbody>
				...
				<?php if ($can_edit) : ?>
					<td><?php echo anchor(SITE_AREA . '/generic_group/pharmacy/edit/' . $record->id, '<span class="glyphicon glyphicon-pencil"></span>' .  $sl++); ?></td>
				<?php else : ?>
