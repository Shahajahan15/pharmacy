                ...
                foreach ($records as $record) :
                    ?>
                        ...
                        <?php if ($can_delete) : ?>
                            ...
                            <?php endif; ?>
                                <td><?php e($sl++); ?></td>
                                <td><?php e($record->pharmacy_name); ?></td>
                            ...
                            <td><a class="btn btn-info btn-xs glyphicon glyphicon-th products_issue_com" mst_id="<?php echo $record->id; ?>"></a></td>
                             <td><a class="btn btn-xs btn-danger reprint" href="<?php echo site_url().'/admin/indoor_requisition_issue/pharmacy/issue_print_complete/'.$record->id; ?>">Print</a></td>
