				...
				<fieldset>
					...
					<table class="table c-table">
			             ...
			             <tbody id="sale_data"> 
			             	...
			             	?>
				             <tr class="success">
				             	<td><?php echo $row->product_name; ?><input type="hidden" name="product_id[]" class="product_id" value="<?php echo $row->medicine_id; ?>"> </td>
				             	...
				             	<td><?php echo $nd_amount; ?><input type="hidden" class="nd_amount" name="nd_amount[]" value="<?php echo $nd_amount; ?>"> </td>
				             	<td><?php echo $sd_percent; ?><input type="hidden" name="sd_percent[]" value="<?php echo $sd_percent; ?>"></td>
