                        ...
                        <tr>
                            ...
                            <td><?php e($record->doctor_name); ?></td>
                             <td><?php echo date('d-m-Y',strtotime(str_replace('/','-',
                                $record->create_date)))?></td>
                           	<td>
                           		
                           		<?php if ($record->status != 2) : ?>
                           		<span>Print</span>
                           		<a href="<?php echo site_url(). '/admin/indoor_prescription_sale/pharmacy/sale/' . $record->id; ?>" class="btn btn-success btn-xs cbtn-mini payment" >Sale</a>
