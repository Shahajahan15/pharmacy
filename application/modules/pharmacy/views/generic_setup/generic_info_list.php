...
<?php
$num_columns	= 8;
$can_delete		= $this->auth->has_permission('Pharmacy.GenericName.Delete');
$can_edit		= $this->auth->has_permission('Pharmacy.GenericName.Edit');
		...
		<table class="table table-striped">
			<thead>
				<tr>
					...
					<th width="40%"><?php echo lang('pharmacy_group_name'); ?></th>					
					<th width="45%"><?php echo lang('pharmacy_generic_name'); ?></th>					
			...
			<tbody>
				...
				<?php if ($can_edit) : ?>
					<td><?php echo anchor(SITE_AREA . '/generic_setup/pharmacy/edit/' . $record['id'], '<span class="glyphicon glyphicon-pencil"></span>' .  $record['group_name']); ?></td>
				<?php else : ?>
					
				<?php endif; ?>				
					<td><?php e($record['generic_name']); ?></td>
