...
<?php
$num_columns = 8;
$can_delete = $this->auth->has_permission('pharmacy.Sub_customer.Delete');
$can_edit = $this->auth->has_permission('pharmacy.Sub_customer.Edit');
...
<?php if ($can_delete && $has_records) : ?>
                    ...
                    <th width="20%"><?php echo lang('pharmacy_sub_customer_phone'); ?></th>
                    <th width="20%"><?php echo lang('pharmacy_sub_customer_status'); ?></th>
                </tr>
            </thead>
<?php if ($has_records) : ?>
                <tfoot>
