				...
				<div class="row">
					<fieldset>
						...
						<div class="<?php echo form_error('tot_due') ? 'error' : ''; ?>">
							<div class='form-group'>
							   <label>Previous Due<span class="required"><?php e(lang('bf_star_mark'));?></span> </label>
					...
					<div class="col-xs-4 col-sm-3 col-md-2 col-lg-2">
						...
						<div class="<?php echo form_error('pharmacy_tot_charge') ? 'error' : ''; ?>">
							<div class='form-group'>
							   ...
							   <input class="form-control pharmacy_tot_charge on-focus-selected" id="pharmacy_tot_charge" name="pharmacy_tot_charge" type="text" value="0" autocomplete="off"/>
							</div>
						</div>		
						</div>
						<div class="col-xs-4 col-sm-2 col-md-2 col-lg-2" style="display: none">
						...
						<div class="<?php echo form_error('less_amount') ? 'error' : ''; ?>">
							<div class='form-group'>
							  ...
							  <!-- <input class="form-control"  id="return_due_infor" name="return_due_infor" value="0" type="hidden"  /> -->

							   <input class="form-control"  id="return_less_infor" name="" value="0" type="hidden"  />
