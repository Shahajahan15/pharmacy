				...
				<tr>
					...
					<td><?php echo $record->contact_no1;?></td>
					 <td><?php echo date('d-m-Y',strtotime(str_replace('/','-',
                            ...
                            <td>
					<td>
						<button type="button" class="btn btn-xs btn-primary receive_details" href="<?php echo site_url().'/admin/product_return/pharmacy/receiving_report/'.$record->id; ?>" >Return Product</button>
					</td>
				</tr>
			<?php } ?>
		</tbody>
