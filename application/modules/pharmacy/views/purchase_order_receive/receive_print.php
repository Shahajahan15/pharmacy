...
<div class=" box box-primary" >
		<div class="col-md-8 col-md-offset-2" id="em_print_id">
				...
				<tr class="">
					...
					<td width="25%">
						<table border="1" width="100%" style="margin-top:10px;">
							...
							<tr>
								<td>Bill No</td>
								<td><?php echo $records[0]['bill_no']; ?></td>								
							</tr>
							<tr>
								<td>Date </td>
			...
			<br>
			<center>
				<p><b>Purchase Order Receive</b></p>
			</center>
			<hr>
			...
			<table class="table">
				...
				<tbody>
					<?php $sl=1;$total_price=0;   foreach($records as $record){
							$total_price=$record['unit_price']*$record['received_qnty']+$total_price;
						...
						<tr>
							  ...
							  <td><?php echo $record['free_qnty']; ?></td>
							  <td><?php echo $record['unit_price']; ?></td>
						   	  <td><?php echo $record['unit_price']*$record['received_qnty']; ?></td>
