...
<div class=" box box-primary" >
		<div class="col-md-8 col-md-offset-2" id="em_print_id">
				...
				<tr class="">
					...
					<td width="25%">
						<table border="1" width="100%" style="margin-top:10px;">
							...
							<tr>
								<td>Reciept no</td>
								<td><?php echo $records['0']->mr_no; ?></td>								
							</tr>
							<tr>
								<td>sale no</td>
			...
			<br>
			<center>
				<p><b>Sub Pharmacy Sale Return(Client Copy)</b></p>
			</center>
			<hr>
			      ...
			      <tr>
      	         ...
      	         <?php }?>
					<tr class="border-top">
						...
						<th><?php echo $record->tot_return_amount; ?></th>
					</tr>
					<!-- <tr>
						<th colspan="4"></th>
						<th>Total Charge Amount</th>
						<th>
						<?php echo $record->tot_charge_amount;?>
					...
					<tr>
						<th colspan="4"></th>
						<th>Total Return</th>
						<th><?php echo intval($record->tot_paid_return_amount);?></th>
			...
			<div class="border">
				<p style="text-align: left;margin:0;padding: 3px;"><b>Total taka(In word) : <?php echo inWords($record->tot_paid_return_amount); ?> Only</b></p>
			</div>
