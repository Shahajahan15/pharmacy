                		...
                		<div class="col-sm-12 col-md-12 col-lg-12">
				            <div class="col-sm-4 col-md-4 col-lg-4 col-lg-offset-4 col-md-offset-4 col-sm-offset-4">
				                <div class="form-group">
				                    <span>
				                        <input type="text" p_type ="2" class="form-control sub-medicine-sale-no-search searbox-clean" placeholder="Search Sales No.....">
				                    </span>
			...
			<div class="row">
				...
				<div class="row">
					<fieldset>
						...
						<div class="col-xs-4 col-sm-2 col-md-2 col-lg-1">
						<div class="<?php echo form_error('total_less_discount') ? 'error' : ''; ?>">
							<div class='form-group'>
							   <label>Total Less Dsc</label>
							   <input class="form-control total_less_discount on-focus-selected" id="total_less_discount" name="total_less_discount" type="text" value="0" readonly=""/>
							</div>
						</div>		
						</div>-->
						...
						<div class="col-xs-4 col-sm-2 col-md-2 col-lg-2" style="display: none;">
						<div class="<?php echo form_error('pharmacy_tot_charge') ? 'error' : ''; ?>">
							<div class='form-group'>
							   ...
							   <input class="form-control pharmacy_tot_charge on-focus-selected" id="pharmacy_tot_charge" name="pharmacy_tot_charge" type="text" autocomplete="off" value="0"/>
							</div>
						</div>		
						</div>
						<div class="col-xs-4 col-sm-2 col-md-2 col-lg-2" style="display: none;">
						...
						<div class="<?php echo form_error('less_amount') ? 'error' : ''; ?>">
							<div class='form-group'>
							   ...
							   <input class="form-control" id="less_amount" name="less_amount" value="0" type="text" readonly="" />
							   <input class="form-control pharmacy_total_less_discount on-focus-selected" id="total_less_dsc" name="pharmacy_total_less_discount" type="hidden" value="0" readonly=""/>
							   <!--<input type="hidden" class="return_due_info" id="return_due_info" name="return_due_info">-->
							   <input type="hidden" class="return_less_info" id="return_less_info" name="return_less_info">
							</div>
						</div>		
						</div>

						<div class="col-xs-4 col-sm-2 col-md-2 col-lg-2">
						<div class="<?php echo form_error('overall_discount') ? 'error' : ''; ?>">
							<div class='form-group'>
							   <label>Overall Discount</label>
							   <input class="form-control" readonly="" id="overall_discount" name="overall_discount" value="0" type="text"  />
							   	<input class="form-control per_overall_discount" id="per_overall_discount" name="per_overall_discount" type="hidden" value="0">

							   <input class="form-control"  id="return_overall_discount" name="return_overall_discount" value="0" type="hidden" />
						...
						<div class="<?php echo form_error('pharmacy_return_taka') ? 'error' : ''; ?>">
							<div class='form-group'>
							   ...
							   <input class="form-control on-focus-selected" id="pharmacy_return_taka" name="pharmacy_return_taka" value="0" type="text" autocomplete="off"/>
							</div>
						</div>		
						</div>
					</fieldset>
