        ...
        <div class="col-sm-12 col-md-12 col-lg-12">
            ...
            <table class="table table-striped m_ph_payment">
                ...
                <tbody>
                    ...
                    $customer_list = $this->Main_pharmacy_sale_list_model->getList('bf_pharmacy_customer', 'id', 'customer_name');
                    $sub_customer_list = $this->Main_pharmacy_sale_list_model->getList('bf_sub_customer', 'id', 'sub_customer_name');
                    foreach ($records as $record) {
                        ...
                        <tr>
                            ...
                            <td>
                                <?php
                                if ($record->sub_cusomer_id == 0) {
                                    echo $customer_list[$record->customer_id];
                                } else {
                                    echo $customer_list[$record->customer_id] . '[' . $sub_customer_list[$record->sub_cusomer_id] . ']';
                                }
                                ?>
                            </td>
