...
<?php
$num_columns = 8;
$can_delete = $this->auth->has_permission('Pharmacy.Shelf.Delete');
$can_edit = $this->auth->has_permission('Pharmacy.Shelf.Edit');
...
<?php if ($can_delete && $has_records) : ?>
                    ...
                    <?php endif; ?>					
                    <th width="60%"><?php echo lang('pharmacy_shelf_name'); ?></th>
                    <th width="60%"><?php echo lang('pharmacy_shelf_des'); ?></th>
                    <th width="38%"><?php echo lang('pharmacy_shelf_status'); ?></th>
                </tr>
            </thead>
<?php if ($has_records) : ?>
                <tfoot>
                    ...
                    ?>
                        ...
                        <?php if ($can_delete) : ?>
                            ...
                            <?php endif; ?>
                                ...
                                <?php if ($can_edit) : ?>
                                <td><?php echo anchor(SITE_AREA . '/shelf/pharmacy/edit/' . $record->id, '<span class="glyphicon glyphicon-pencil"></span>' . $record->self_name,'class="bf-edit-action"'); ?></td>
                            <?php else : ?>
								<td><?php e($record->self_name); ?></td>
                            <?php endif; ?>
                            <td><?php e($record->self_desc); ?></td>
                            <td>
