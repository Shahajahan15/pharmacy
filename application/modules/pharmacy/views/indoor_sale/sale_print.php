...
<div class=" box box-primary" >
		<div class="col-md-8 col-md-offset-2" id="em_print_id">
			...
			<br>
			<center>
				<p><b>Indoor Sale(Client Copy)</b></p>
			</center>
			<hr>
			<hr>
			...
			<div class="border" style="padding: 3px;">
				<table>
					<tr>
						...
						<td>:</td>
						<td width="100%"><?php echo $patient_info->patient_id; ?></td>
					</tr>
					<tr>
						<td width="20%" class="">Patient Name </td>
						<td>:</td>
						<td width="100%"><?php echo $patient_info->patient_name; ?></td>
					</tr>
					<tr>
						<td width="20%">Contact Number </td>
						<td>:</td>
						<td width="100%"><?php echo $patient_info->contact_no; ?></td>
					</tr>
					<tr>
				...
				<tbody>
					<?php $sl=1; foreach($records as $record){
                       ...
                       $total_discount=$record->tot_normal_discount+$record->tot_service_discount+$record->tot_less_discount;
						...
						<tr>
							  <td><?php echo $sl++; ?></td>
							  <td class=""><?php echo $record->product_name.'&nbsp; >> &nbsp;'.$record->category_name?></td> 
			...
			<div class="border">
				<p style="text-align: left;margin:0;padding: 3px;" class=""><b>Total Paid(In word) : <?php echo inwords($record->tot_paid) ?> Only</b></p>
			</div>
