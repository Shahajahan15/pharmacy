	...
	<?php echo form_open($this->uri->uri_string()); ?>
		<table class="table table-striped">
			...
			<tbody>
				...
				<?php if ($can_edit) : ?>
						<td><?php echo anchor(SITE_AREA . '/patient_type_setup/library/edit/' . $record->id, '<span class="glyphicon glyphicon-pencil"></span>' .$record->type_name); ?></td>
				<?php else : ?>
					<td><?php e($record->type_name); ?></td>
				<?php endif; ?>
