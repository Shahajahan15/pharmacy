		...
		<table class="table table-striped">
			<thead>
				<tr>
					...
					<th width="40%"><?php echo lang('library_company_name'); ?></th>					
					<th width="45%"><?php echo lang('library_company_address'); ?></th>					
			...
			<tbody>
				...
				<?php if ($can_edit) : ?>
					<td><?php echo anchor(SITE_AREA . '/company_info/library/edit/' . $record->id,'<span class="glyphicon glyphicon-pencil"></span>' .  $record->company_name,'class="bf-edit-action"'); ?></td>
				<?php else : ?>
