  ...
  <div class="col-xs-8 col-sm-4 col-md-4 col-lg-4">
	<div class="form-group <?php echo form_error('district_ame') ? 'error' : ''; ?>">
        ...
        <div class="form-group <?php echo form_error('area_name') ? 'error' : ''; ?>">
                        ...
                        <input class="form-control" id='library_zone_area_name' type='text' name='library_zone_area_name' maxlength="285" value="<?php echo set_value('library_zone_area_name', isset($area_details['area_name']) ? $area_details['area_name'] : ''); ?>" />
                        <span class='help-inline'><?php echo form_error('area_name'); ?></span>
                    </div>

        </div>
	  <div class="col-xs-8 col-sm-4 col-md-4 col-lg-4">
				<div class="form-group <?php echo form_error('area_status') ? 'error' : ''; ?>">
						<label><?php echo lang('bf_status').lang('bf_form_label_required');?></label>
						<select class="form-control" name="library_zone_area_status" id="library_zone_area_status" required="">

							<option value="1" <?php if(isset($area_details['area_status'])){if($area_details['area_status'] == 1){ echo "selected";}}?> >Active</option>
							<option value="0" <?php if(isset($area_details['area_status'])){if($area_details['area_status'] == 0){ echo "selected";}}?>>Inactive</option>

						 </select>
						<span class='help-inline'><?php echo form_error('area_status'); ?></span>
					</div>
				</div>
