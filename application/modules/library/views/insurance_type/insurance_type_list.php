		...
		<table class="table table-striped">
			<thead>
				<tr>					
					...
					<?php endif;?>                 
					<th width="10%"><?php echo lang('INSURANCE_TYPE_ID'); ?></th>
					<th width="20%"><?php echo lang('INSURANCE_TYPE_NAME'); ?></th>
					<th width="20%"><?php echo lang('INSURANCE_TYPE_CODE'); ?></th>	
			...
			<tbody>
				...
				<tr>
					...
					<td class="column-check">
						<input type="checkbox" name="checked[]" value="<?php echo $record->INSURANCE_TYPE_ID; ?>" />
					</td>
						<?php endif;?>
						
					<?php if ($can_edit) : ?>
					<td>
						<?php echo anchor(SITE_AREA . '/insurance_type/library/insurance_type_create/' . $record->INSURANCE_TYPE_ID, '<span class="glyphicon glyphicon-pencil"></span>' .$record->INSURANCE_TYPE_ID); ?>
					</td>
					<?php else : ?>
					<?php endif; ?> 
					<td><?php e($record->INSURANCE_TYPE_NAME); ?></td>
					<td><?php e($record->INSURANCE_TYPE_CODE); ?></td>		
