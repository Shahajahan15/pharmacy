		...
		<table class="table table-striped">
			<thead>
				<tr>
					...
					<th><?php echo lang('library_bank_name'); ?></th>					
					<th><?php echo lang('library_branch_name'); ?></th>					
					<th><?php echo lang('library_branch_account_no'); ?></th>
			...
			<tbody>
				...
				<?php if ($can_edit) : ?>
					<td><?php echo anchor(SITE_AREA . '/branch_setup/library/edit/' . $record['id'], '<span class="glyphicon glyphicon-pencil"></span>' .  $record['bank_name'],'class="bf-edit-action"'); ?></td>
				<?php else : ?>
					
				<?php endif; ?>				
					<td><?php e($record['branch_name']); ?></td>
					<td><?php e($record['account_no']); ?></td>
