...
<?php
$num_columns	= 8;
$can_delete		= $this->auth->has_permission('Lib.OtherService.Delete');
$can_edit		= $this->auth->has_permission('Lib.OtherService.Edit');
		...
		<table class="table table-striped">
			<thead>
				<tr>
					...
					<th><?php echo lang('library_service_name'); ?></th>					
					<th><?php echo lang('library_otherservice_name'); ?></th>					
					<th><?php echo lang('other_service_price'); ?></th>
			...
			<tbody>
				...
				<?php if ($can_edit) : ?>
					<td><?php echo anchor(SITE_AREA . '/otherservice_setup/library/edit/' . $record['id'], '<span class="glyphicon glyphicon-pencil"></span>' .  $record['service_name'],'class="bf-edit-action"'); ?></td>
				<?php else : ?>
					
				<?php endif; ?>				
					<td><?php e($record['otherservice_name']); ?></td>
