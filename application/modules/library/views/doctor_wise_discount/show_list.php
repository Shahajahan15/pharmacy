		...
		<table class="table table-striped">
			...
			<tbody>
				...
				<tr>					
					...
					<td><?php echo $record->dr_discount; ?></td>
					<td><?php echo $record->hospital_discount; ?></td>
					<td><?php echo sprintf("%.2f", ($record->dr_discount + $record->hospital_discount)); ?></td> 
					<td><?php echo ($record->status==1)?'<p class="btn btn-info btn-xs disabled">Approved</p>':'<p class="btn btn-danger btn-xs disabled">Pending</p>'; ?></td>
