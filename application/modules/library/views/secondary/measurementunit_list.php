		...
		<table class="table table-striped">
			<thead>
				<tr>
					...
					<?php endif;?>					
					<th ><?php echo lang('lib_measurement_unit_name'); ?></th>
					<th ><?php echo lang('lib_measurement_unit_details'); ?></th>
					<th ><?php echo lang('lib_measurement_unit'); ?></th>
					<th ><?php echo lang('lib_measurement_unit_status'); ?></th>
				</tr>
			</thead>
			<?php if ($has_records) : ?>
			<tfoot>
