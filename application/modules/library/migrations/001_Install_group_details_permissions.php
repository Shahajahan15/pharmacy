...
class Migration_Install_group_details_permissions extends Migration
{
	...
	private $permission_values = array(
		array(
			'name' => 'Group_Details.Library.View',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'Group_Details.Library.Create',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'Group_Details.Library.Edit',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'Group_Details.Library.Delete',
			'description' => '',
			'status' => 'active',
		),
	);
