                ...
                <fieldset>
                    <div class="col-sm-12 col-md-2 col-lg-2">
                        <div class="form-group">
                            ...
                            <input type="text" name="salary_start_month" class="form-control datepickerCommon" required="">
                        </div>                        
                    </div>
                    <div class="col-sm-12 col-md-3 col-lg-3">
                        <div class="form-group">
                            <label class="control-label">Total Gross Amount</label>
                            <input type="text" name="total_gross_amount" required="" class=" total_gross_amount form-control decimal" required="">
                        </div>                        
                    </div>
