...
<div class="box box-primary">
    <?php echo form_open_multipart($this->uri->uri_string(), 'role="form", class="form-horizontal"'); ?>
        ...
        <fieldset style="padding-left: 20px;">
            ...
            <div class="col-xs-6 col-sm-3 col-md-3 col-lg-3">
                ...
                <div class="form-group <?php echo form_error('EMP_NAME') ? 'error' : ''; ?>">
                    ...
                    <input type='text' class="form-control" name='hrm_employee_name' id='hrm_employee_name'
                           value="<?php echo set_value('EMP_NAME', isset($employee_details['EMP_NAME']) ? $employee_details['EMP_NAME'] : ''); ?>"
                           required="" maxlength="100" tabindex="1"/>
            ...
            <div class="col-xs-6 col-sm-3 col-md-3 col-lg-3">
                ...
                <div class="form-group <?php echo form_error('EMP_FATHER_NAME') ? 'error' : ''; ?>">
                    ...
                    <input type='text' class="form-control" name='hrm_employee_father' id='hrm_employee_father'
                           value="<?php echo set_value('employee_father', isset($employee_details['EMP_FATHER_NAME']) ? $employee_details['EMP_FATHER_NAME'] : ''); ?>"
                           required="" maxlength="100" tabindex="3"/>
            ...
            <div class="col-xs-6 col-sm-3 col-md-3 col-lg-3">
                ...
                <div class="form-group <?php echo form_error('EMP_MOTHER_NAME') ? 'error' : ''; ?>">
                    ...
                    <input type='text' class="form-control" name='hrm_employee_mother' id='hrm_employee_mother'
                           value="<?php echo set_value('EMP_MOTHER_NAME', isset($employee_details['EMP_MOTHER_NAME']) ? $employee_details['EMP_MOTHER_NAME'] : ''); ?>"
                           required="" maxlength="100" tabindex="5"/>
            ...
            <div class="col-xs-6 col-sm-3 col-md-3 col-lg-3">
                ...
                <div class="form-group <?php echo form_error('BIRTH_DATE') ? 'error' : ''; ?>">
                    ...
                    <input type="text" class="form-control datepickerCommon" name="hrm_employee_birth_day"
                           id="hrm_employee_birth_day"
                           value="<?php echo set_value('BIRTH_DATE', isset($employee_details['BIRTH_DATE']) ? $employee_details['BIRTH_DATE'] : ''); ?>"
                           title="<?php e(lang('hrm_employee_birth_day')); ?>" required="" tabindex="7"/>
                </div>
            </div>
            ...
            <div class="col-xs-6 col-sm-3 col-md-3 col-lg-3">
                ...
                <div class="form-group <?php echo form_error('BIRTH_PLACE') ? 'error' : ''; ?>">
                    ...
                    <input type='text' class="form-control" name='hrm_employee_birth_place'
                           id='hrm_employee_birth_place' maxlength="30"
                           value="<?php echo set_value('BIRTH_PLACE', isset($employee_details['BIRTH_PLACE']) ? $employee_details['BIRTH_PLACE'] : ''); ?>"
                           tabindex="8"/>
            ...
            <div class="col-xs-6 col-sm-3 col-md-3 col-lg-3">
                ...
                <div class="form-group <?php echo form_error('GENDER') ? 'error' : ''; ?>">
                    ...
                    <select name="hrm_employee_sex" id="hrm_employee_sex" class="form-control" required=""
                            tabindex="10">
                        ...
                        foreach ($gender_list as $key => $val) {
                            ...
                            if (isset($employee_details['GENDER'])) {
                                if ($employee_details['GENDER'] == $key) {
                                    echo "selected";
                                }
                            }
                            echo ">" . $val . "</option>";
            ...
            <div class="col-xs-6 col-sm-3 col-md-3 col-lg-3">
                ...
                <div class="form-group <?php echo form_error('MARITAL_STATUS') ? 'error' : ''; ?>">
                    ...
                    <select class="form-control" name="hrm_employee_marital_status" id="hrm_employee_marital_status"
                        ...
                        foreach ($marital_status as $key => $val) {
                            ...
                            if (isset($employee_details['MARITAL_STATUS'])) {
                                if ($employee_details['MARITAL_STATUS'] == $key) {
                                    echo "selected ";
                                }
                            }
                            echo ">" . $val . "</option>";
            ...
            <div class="col-xs-6 col-sm-3 col-md-3 col-lg-3">
                ...
                <div class="form-group <?php echo form_error('RELIGION') ? 'error' : ''; ?>">
                    ...
                    <select class="form-control" name="hrm_employee_religion" id="hrm_employee_religion" required=""
                        ...
                        foreach ($religion as $key => $val) {
                            ...
                            if (isset($employee_details['RELIGION'])) {
                                if ($employee_details['RELIGION'] == $key) {
                                    echo "selected ";
                                }
                            }
                            echo ">" . $val . "</option>";
            ...
            <div class="col-xs-6 col-sm-3 col-md-3 col-lg-3">
                ...
                <div class="form-group <?php echo form_error('NATIONALITY') ? 'error' : ''; ?>">
                    <label><?php echo lang('hrm_employee_nationality'); ?></label>
                    <select name="hrm_employee_nationality" id="hrm_employee_nationality" class="form-control"
                            tabindex="14">
                        <option value=""><?php echo lang('bf_msg_selete_one'); ?></option>
                        <?php
                        foreach ($nationality as $key => $val) {
                            ...
                            if (isset($employee_details['NATIONALITY'])) {
                                if ($employee_details['NATIONALITY'] == $key) {
                                    echo "selected ";
                                }
                            }
                            echo ">" . $val . "</option>";
            ...
            <div class="col-xs-6 col-sm-3 col-md-3 col-lg-3">
                ...
                <div class="form-group <?php echo form_error('NATIONAL_ID') ? 'error' : ''; ?>">
                    <label><?php echo lang('hrm_employee_national_id') . lang('bf_form_label_required'); ?><span
                                id="checkNationalid" style="color:#F00; font-size:12px;"></span></label>
                    <input type='text' class="form-control phonenumber" name='hrm_employee_national_id'
                           id='hrm_employee_national_id'
                           value="<?php echo set_value('NATIONAL_ID', isset($employee_details['NATIONAL_ID']) ? $employee_details['NATIONAL_ID'] : ''); ?>"
                           required="" maxlength="30" tabindex="15" onblur="nationalidCheck()"/>
            ...
            <div class="col-xs-6 col-sm-3 col-md-3 col-lg-3">
                ...
                <div class="form-group <?php echo form_error('EMPLOYEE_ID') ? 'error' : ''; ?>">
                    ...
                    <input type='text' class="form-control" name='employee_id' id='employee_id'
                           value="<?php echo set_value('employee_id', isset($employee_details['EMPLOYEE_ID']) ? $employee_details['EMPLOYEE_ID'] : ''); ?>"
                           required="" maxlength="100" tabindex="3"/>
            ...
            <div class="col-xs-6 col-sm-3 col-md-3 col-lg-3">
                ...
                <div class="form-group <?php echo form_error('EMP_TYPE') ? 'error' : ''; ?>">
                    ...
                    <select name="hrm_employee_type" id="hrm_employee_type" class="form-control" required=""
                            tabindex="16">
                        <option value=""><?php echo lang('bf_msg_selete_one'); ?></option>
                        <?php
                        foreach ($emp_type as $val) {
                            ...
                            if (isset($employee_details['EMP_TYPE'])) {
                                if ($employee_details['EMP_TYPE'] == $val->id) {
                                    echo "selected ";
                                }
                            }
            ...
            <div class="col-xs-6 col-sm-3 col-md-3 col-lg-3">
                ...
                <div class="form-group <?php echo form_error('EMP_JOB_NATURE') ? 'error' : ''; ?>">
                    ...
                    <select name="hrm_employee_job_nature" id="hrm_employee_job_nature" class="form-control" required=""
                            tabindex="17">
                        <option value=""><?php echo lang('bf_msg_selete_one'); ?></option>
                        <?php
                        foreach ($job_nature as $key => $val) {
                            ...
                            if (isset($employee_details['EMP_JOB_NATURE'])) {
                                if ($employee_details['EMP_JOB_NATURE'] == $key) {
                                    echo "selected ";
                                }
                            }
                            echo ">" . $val . "</option>";
            ...
            <div class="col-xs-6 col-sm-3 col-md-3 col-lg-3">
                ...
                <div class="form-group <?php echo form_error('EMP_DEPARTMENT') ? 'error' : ''; ?>">
                    ...
                    <select name="employee_emp_department" id="employee_emp_department" class="form-control" required=""
                            tabindex="18">
                        <option value=""><?php echo lang('bf_msg_selete_one'); ?></option>
                        <?php
                        foreach ($department_list as $department) {
                            ...
                            if (isset($employee_details['EMP_DEPARTMENT'])) {
                                if ($employee_details['EMP_DEPARTMENT'] == $department->dept_id) {
                                    echo "selected ";
                                }
                            }
            ...
            <div class="col-xs-6 col-sm-3 col-md-3 col-lg-3">
                ...
                <div class="form-group <?php echo form_error('EMP_DESIGNATION') ? 'error' : ''; ?>">
                    ...
                    <select name="hrm_employee_designation" id="hrm_employee_designation" class="form-control"
                        ...
                        foreach ($designation_list as $deignation) {
                            ...
                            if (isset($employee_details['EMP_DESIGNATION'])) {
                                if ($employee_details['EMP_DESIGNATION'] == $deignation->DESIGNATION_ID) {
                                    echo "selected ";
                                }
                            }
            ...
            <div class="col-xs-6 col-sm-3 col-md-3 col-lg-3">
                ...
                <div class="form-group <?php echo form_error('EMP_GRADE') ? 'error' : ''; ?>">
                    ...
                    <select name="hrm_employee_grade" id="hrm_employee_grade" class="form-control" required=""
                            tabindex="20">
                        <option value=""><?php echo lang('bf_msg_selete_one'); ?></option>
                        <?php
                        foreach ($grade_list as $grade) {
                            ...
                            if (isset($employee_details['EMP_GRADE'])) {
                                if ($employee_details['EMP_GRADE'] == $grade->GRADE_ID) {
                                    echo "selected ";
                                }
                            }
            ...
            <div class="col-xs-6 col-sm-3 col-md-3 col-lg-3">
                ...
                <div class="form-group <?php echo form_error('JOINNING_DATE') ? 'error' : ''; ?>">
                    ...
                    <input type="text" class="form-control datepickerCommon" name="employee_joining_date"
                           id="employee_joining_date"
                           value="<?php echo set_value('JOINNING_DATE', isset($employee_details['JOINNING_DATE']) ? $employee_details['JOINNING_DATE'] : ''); ?>"
                           title="<?php e(lang('employee_joining_date')); ?>" required="" tabindex="21"/>
            ...
            <div class="col-xs-6 col-sm-3 col-md-3 col-lg-3">
                ...
                <div class="form-group <?php echo form_error('JOB_CONFIRM_DATE') ? 'error' : ''; ?>">
                    ...
                    <input type="text" class="form-control datepickerCommon" name="employee_confirmarion_date"
                           id="employee_confirmarion_date"
                           value="<?php echo set_value('JOB_CONFIRM_DATE', isset($employee_details['JOB_CONFIRM_DATE']) ? $employee_details['JOB_CONFIRM_DATE'] : ''); ?>"
                           title="<?php e(lang('JOB_CONFIRM_DATE')); ?>" required="" tabindex="22"/>
            ...
            <div class="col-xs-6 col-sm-3 col-md-3 col-lg-3">
                ...
                <div class="form-group <?php echo form_error('PASSPORT_NO') ? 'error' : ''; ?>">
                    ...
                    <input class="form-control" id='hrm_employee_passport_no' name='hrm_employee_passport_no'
                           type='text' maxlength="30"
                           value="<?php echo set_value('PASSPORT_NO', isset($employee_details['PASSPORT_NO']) ? $employee_details['PASSPORT_NO'] : ''); ?>"
                           tabindex="23" onblur="passportCheck()"/>
            ...
            <div class="col-xs-6 col-sm-3 col-md-3 col-lg-3">
                ...
                <div class="form-group <?php echo form_error('DRIVING_LICENCE') ? 'error' : ''; ?>">
                    ...
                    <input type='text' class="form-control" id='hrm_employee_driving_licence'
                           name='hrm_employee_driving_licence'
                           value="<?php echo set_value('DRIVING_LICENCE', isset($employee_details['DRIVING_LICENCE']) ? $employee_details['DRIVING_LICENCE'] : ''); ?>"
                           maxlength="30" tabindex="24" onblur="drivingLicencetCheck()"/>
            ...
            <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6">
                ...
                <div class="form-group <?php echo form_error('EMP_DESIGNATION_TWO') ? 'error' : ''; ?>">
                    ...
                    <input type='text' class="form-control" id='emp_designation_two' name='emp_designation_two'
                           value="<?php echo set_value('EMP_DESIGNATION_TWO', isset($employee_details['EMP_DESIGNATION_TWO']) ? $employee_details['EMP_DESIGNATION_TWO'] : ''); ?>"
                           maxlength="30" tabindex="24" onblur="drivingLicencetCheck()"/>
                    ...
                    <select name="employee_status" id="employee_status" class="form-control" required="" tabindex="26">
                        ...
                        foreach ($status as $vkey => $vval) {
                            ...
                            if (isset($employee_details['STATUS'])) {
                                if ($employee_details['STATUS'] == $vkey) {
                                    echo "selected";
                                }
                            }
                            echo ">" . $vval . "</option>";
            ...
            <div class="col-xs-6 col-sm-3 col-md-3 col-lg-3">
                ...
                <div class="form-group <?php echo form_error('EMP_PHOTO') ? 'error' : ''; ?>">
                    ...
                    <input type='file' id='hrm_employee_photo' name='hrm_employee_photo'
                           value="<?php echo set_value('EMP_PHOTO', isset($employee_details['EMP_PHOTO']) ? $employee_details['EMP_PHOTO'] : ''); ?>"
                           tabindex="27"/>
            ...
            <fieldset>
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 text-center">
                    ...
                    <input type="submit" name="save" class="btn btn-primary btn-sm"
                           value="<?php echo lang('bf_action_save') . ' ' . lang('bf_action_next'); ?>"/>
                    <?php echo lang('bf_or'); ?>
