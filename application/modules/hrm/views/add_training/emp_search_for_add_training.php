					...
					<div class="col-sm-12 col-md-12 col-lg-12">
						<div class="col-sm-6 col-md-3 col-lg-3  ">
							<div class="form-group">
								...
								<input type='text' name='employee_id' class="form-control " id='employee_id'       tabindex="1"/>
						...
						<div class="col-sm-6 col-md-3 col-lg-3">
							<div class="form-group">
								...
								<input type='text' name='employee_name' class="form-control " id='employee_name'       tabindex="2"/>
						...
						<div class="col-sm-12 col-md-12 col-lg-12">
							<div class="form-group text-center ">								
								<button type="button" name="" id="EmpSearchButton" class="btn  btn-primary btn-md"  tabindex="5"><span class="glyphicon glyphicon-search"> </span>Search</button>
							</div>
						</div>
					</div>
				</div>
