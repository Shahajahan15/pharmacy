...
class Dashboard extends Admin_Controller
{
    ...
    public function index()
    {
        $sendData = array(
            ...
            'mcashIn' => (float)$this->getMainTodayCashIn(),
        ...
        if ($this->session->userdata('role_id') == 1 || $this->session->userdata('role_id') == 7 || $this->session->userdata('role_id') == 9 ) {
                    Template::set('toolbar_title', 'Admin Dashboard');
                    Template::set($sendData);
                    $this->view('dashboard/index', Template::getData());
            }
        elseif ($this->session->userdata('role_id') == 10) {
                    Template::set('toolbar_title', 'Receiption Dashboard');
                    Template::set($sendData);
                    $this->view('dashboard/receiption', Template::getData());
            }    
        elseif ($this->session->userdata('role_id') == 16 || $this->session->userdata('role_id') == 23) {
                    ...
                    Template::set($sendData);
                    $this->view('dashboard/dashboard', Template::getData());
    ...
    public function getCashCollection()
    {
        ...
        public function getMainTodayCashIn()
    {
