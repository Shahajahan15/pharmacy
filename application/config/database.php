...
if (defined('CI_VERSION') && substr(CI_VERSION, 0, 1) != '2') {
    ...
    $db['default'] = array(
      ...
      //  'database'     => 'hospital_db1',
       // 'database'     => 'hospital_db_final1',
      //  'database'     => 'final-hospital',
       // 'database'     => 'hospital_db2',
         //'database'     => 'ra-hospital',
       // 'database'     => 'new_hospital',
        //'database'     => 'nnew_hospital',
       // 'database'     => 'new_hospital_03_10_2017',
        'database'     => 'pharmacy',
        'dbdriver'     => 'mysqli',
        'dbprefix'     => 'bf_',
    ...
    $db['default']['password'] = '';
    $db['default']['database'] = 'hospital-12-11-2017';
    $db['default']['port']     = '';
